...
For more information on custom effects, see [Writing Custom Effects](https://docs.unity3d.com/Assets/com.unity.postprocessing@3.4.0@latest?subfolder=/manual/Writing-Custom-Effects.html).
